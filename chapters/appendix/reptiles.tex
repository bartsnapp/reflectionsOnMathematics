...
\end{enumerate}
Working with partners, show that each of these polygons is a rep-3-tile.
\end{prob}
...
rep-4-tile. Give an examples of both, and compute the perimeter and
...
\]
Working with partners, show that each of these polygons is a rep-4-tile.
\end{prob}
