...
\[
  \begin{tikzpicture}[scale=0.4,rotate=90]%% adopted from http://www.texample.net/tikz/examples/lattice-points/
    \clip (-.3,-.3) rectangle ({48*sqrt(3)/2+.3},24+.3); % Clips the picture...
    ...
    \foreach \x in {0,1,...,48}{% Two indices running over each
      \foreach \y in {-26,-25,...,24}{% node on the grid we have drawn 
