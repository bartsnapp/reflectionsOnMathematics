...
\begin{ques} Are there other regular convex polygons other than the ones shown above?
\end{ques}

We'll give you the answer to this one:

\begin{thm}\label{T:5CP} There are at most $5$ regular convex polyhedra.
\end{thm}
...
paper. Being that paper is effectively 2-dimensional, it is seemingly
...
represents a real cube. You may not think this is much of a miracle,
...
from Flatland, Louie Llama!  Here's Louie Llama chillin in front of
his house:
\[
...
he is surrounded by four walls, nothing could possibly get inside or
...
\]
Remember, Louie Llama can only see stuff in the plane that is
...
never seen before. He can see inside closed building and even inside
...
next to the original but offset a tad. Then connect corresponding
vertexes. Let's see your shadow of the cube in the box below:
\[
\includegraphics{../graphics/box.pdf}
\]
...
your shadow of the cube and connect corresponding vertexes. Let's see it in the box below:
\[
\includegraphics{../graphics/box.pdf}
\]
...
Living in our three-dimensional world as we do, it truly seems utterly
...
the tool of mathematics, physicist are discovering that our universe
is filled with symmetry. The symmetries we are finding cannot be
explained as the symmetry of a 2-dimensional or 3-dimensional
